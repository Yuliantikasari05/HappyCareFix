...
@section('title', 'Family Tours - HappyCare')

@section('content')
<!-- Hero Section -->
<section class="relative py-24 bg-gradient-to-br from-purple-600 via-blue-600 to-indigo-600 overflow-hidden">
    <!-- Background Pattern -->
    ...
    <div class="container px-4 mx-auto relative">
        <div class="max-w-4xl mx-auto text-center">
            ...
            <p class="mb-8 text-xl text-white/90 leading-relaxed" data-aos="fade-up" data-aos-delay="200">
                Fun and educational tours for the whole family. Create lasting memories with activities designed for all ages.
            </p>
            ...
            <nav class="flex justify-center" aria-label="Breadcrumb" data-aos="fade-up" data-aos-delay="400">
                <ol class="flex items-center space-x-2 text-white/80">
                    ...
                    <li class="text-white font-medium">Family</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="container px-4 mx-auto">
        <div class="flex flex-wrap justify-center gap-4" data-aos="fade-up">
            ...
            <a href="{{ route('tour.family') }}" 
               class="inline-flex items-center px-6 py-3 text-white bg-purple-600 rounded-full hover:bg-purple-700 transition-colors">
    ...
    <div class="container px-4 mx-auto">
                    ...
                    <div class="overflow-hidden bg-white rounded-2xl shadow-sm hover:shadow-xl transition-all duration-500 transform hover:-translate-y-2">
                        ...
                        <div class="relative h-64 overflow-hidden">
                            ...
                            @else
                                <div class="flex items-center justify-center w-full h-full bg-gradient-to-br from-purple-100 to-blue-100">
                                    <i data-lucide="users" class="w-16 h-16 text-purple-600"></i>
                                </div>
                            @endif
                        ...
                        <div class="p-6">
                            ...
                            <div class="flex flex-wrap gap-2 mb-4">
                                ...
                                <span class="px-2 py-1 text-xs font-medium text-purple-700 bg-purple-50 rounded-full">
                                    {{ $feature }}
                                </span>
                                @endforeach
                            </div>
                            ...
                            <div class="flex items-center justify-between pt-4 border-t border-gray-100">
                                ...
                                <a href="{{ route('tour.show', $tour->slug) }}" 
                                   class="inline-flex items-center px-4 py-2 text-sm font-semibold text-white bg-purple-600 rounded-lg hover:bg-purple-700 transition-colors">
                                    View Details
        ...
        @else
            ...
            <div class="text-center py-16" data-aos="fade-up">
                <div class="flex items-center justify-center w-24 h-24 mx-auto mb-6 rounded-full bg-purple-100">
                    <i data-lucide="users" class="w-12 h-12 text-purple-600"></i>
                </div>
                <h3 class="mb-4 text-2xl font-bold text-gray-900">No Family Tours Available</h3>
                <p class="mb-8 text-gray-600 max-w-md mx-auto">
                    We're currently preparing exciting family tours for you. Please check back later!
                </p>
                <a href="{{ route('home') }}" 
                   class="inline-flex items-center px-6 py-3 text-white bg-purple-600 rounded-lg hover:bg-purple-700 transition-colors">
...
<section class="py-24 bg-gradient-to-br from-purple-50 via-white to-blue-50">
    <div class="container px-4 mx-auto">
        <div class="max-w-3xl mx-auto mb-16 text-center" data-aos="fade-up">
            <h2 class="mb-4 text-3xl font-bold text-gray-900 md:text-4xl">
                Why Choose <span class="text-purple-600">Family Tours</span>?
            </h2>
            <div class="w-20 h-1 mx-auto mb-8 bg-gradient-to-r from-purple-500 to-blue-500 rounded-full"></div>
            <p class="text-lg text-gray-600">
                Create unforgettable family memories with tours designed to engage and entertain every family member.
            </p>
        </div>
        ...
        <div class="grid grid-cols-1 gap-8 md:grid-cols-3">
            ...
            <div class="text-center" data-aos="fade-up" data-aos-delay="100">
                <div class="flex items-center justify-center w-16 h-16 mx-auto mb-6 rounded-full bg-purple-100">
                    <i data-lucide="baby" class="w-8 h-8 text-purple-600"></i>
                </div>
                <h3 class="mb-4 text-xl font-bold text-gray-900">Kid-Friendly</h3>
                <p class="text-gray-600 leading-relaxed">
                    All activities are designed to be safe and engaging for children of all ages, with special attention to their needs.
                </p>
            </div>
            
            <!-- Benefit 2 -->
            <div class="text-center" data-aos="fade-up" data-aos-delay="200">
                <div class="flex items-center justify-center w-16 h-16 mx-auto mb-6 rounded-full bg-blue-100">
                    <i data-lucide="graduation-cap" class="w-8 h-8 text-blue-600"></i>
                </div>
                <h3 class="mb-4 text-xl font-bold text-gray-900">Educational</h3>
                <p class="text-gray-600 leading-relaxed">
                    Learn together as a family with interactive experiences that combine fun with educational content.
                </p>
            </div>
            
            <!-- Benefit 3 -->
            <div class="text-center" data-aos="fade-up" data-aos-delay="300">
                <div class="flex items-center justify-center w-16 h-16 mx-auto mb-6 rounded-full bg-indigo-100">
                    <i data-lucide="heart" class="w-8 h-8 text-indigo-600"></i>
                </div>
                <h3 class="mb-4 text-xl font-bold text-gray-900">Bonding Time</h3>
                <p class="text-gray-600 leading-relaxed">
                    Strengthen family bonds through shared experiences and create memories that will last a lifetime.
                </p>
            </div>
        </div>
    </div>
